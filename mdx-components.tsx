...
const components = {
  h1: (props: HeadingProps) => (
    <h1 className="text-4xl font-bold pt-12 mb-0" {...props} />
  ),
  h2: (props: HeadingProps) => (
    <h2
      className="text-3xl font-semibold text-gray-800 dark:text-zinc-200 mt-8 mb-3"
      {...props}
    />
  ),
  h3: (props: HeadingProps) => (
    <h3
      className="text-2xl font-semibold text-gray-800 dark:text-zinc-200 mt-8 mb-3"
      {...props}
    />
  ),
