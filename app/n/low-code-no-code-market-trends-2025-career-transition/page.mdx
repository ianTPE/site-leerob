import LowCodeMarketDiagram from './low-code-market-diagram.tsx'
import Image from 'next/image'
import lowcodenocodemarkettrends from './low-code-no-code-market-trends-2025-career-transition.png';
...
export const metadata = {
  ...
  alternates: {
    canonical: '/n/low-code-no-code-market-trends-2025-career-transition'
  }
};

<div className="max-w-full">
  <div className="mb-8">
    <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-black dark:text-white">
      【2025趨勢】低代碼/無代碼市場爆發：從企業高管到AI創業者的轉型之路
    </h1>
    <div className="w-full border border-gray-200 rounded-md p-4 bg-white">
      <Image 
        src={lowcodenocodemarkettrends} 
        alt="低代碼/無代碼市場趨勢" 
